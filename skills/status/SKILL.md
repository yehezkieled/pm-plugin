...
3. Add at most three lines of reading: what is ready to pick up, what looks stuck (in progress with no PR, proposed changes waiting, review waiting on a merge), and the single most useful next command (/pm:work, /pm:plan apply Txxx, /pm:retro when every ticket of the current milestone is done).
